...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SapiensDataAPI.Models.Expense", b =>
                {
                    ...
                    b.Property<string>("ApplicationUserModelId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ApplicationUserModelId1");
            ...
            modelBuilder.Entity("SapiensDataAPI.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("UserId")
                        .HasName("PK__User__B9BE370F03BB93CC");

                    b.HasIndex(new[] { "AccountEmail" }, "UQ__User__713342DDA1F6D29E")
                        .IsUnique();

                    b.HasIndex(new[] { "Username" }, "UQ__User__F3DBC5725409B28E")
                        .IsUnique();
            ...
            modelBuilder.Entity("SapiensDataAPI.Models.BankAccount", b =>
                {
                    ...
                    b.HasOne("SapiensDataAPI.Models.User", "User")
                        .WithMany("BankAccounts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("SapiensDataAPI.Models.Debt", b =>
                {
                    ...
                    b.HasOne("SapiensDataAPI.Models.User", "CreditorUser")
                        .WithMany("Debts")
            ...
            modelBuilder.Entity("SapiensDataAPI.Models.Expense", b =>
                {
                    ...
                    b.HasOne("SapiensDataAPI.Models.ApplicationUserModel", null)
                        ...
                        .HasForeignKey("ApplicationUserModelId1");
                    ...
                    b.HasOne("SapiensDataAPI.Models.User", "SourceUser")
                        .WithMany("ExpenseSourceUsers")
            ...
            modelBuilder.Entity("SapiensDataAPI.Models.Investment", b =>
                {
                    ...
                    b.HasOne("SapiensDataAPI.Models.User", "LoanedToUser")
                        .WithMany("Investments")
            ...
            modelBuilder.Entity("SapiensDataAPI.Models.UserRelationship", b =>
                {
                    ...
                    b.HasOne("SapiensDataAPI.Models.User", "RelatedUser")
                        .WithMany("UserRelationshipRelatedUsers")
