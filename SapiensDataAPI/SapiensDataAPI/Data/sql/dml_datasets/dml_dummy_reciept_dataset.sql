...
-- Insert Address for the Store
INSERT INTO Address (street, house_number, postal_code, city, state, country)
VALUES ('Breitenbachstr.', '50', '41065', 'Mönchengladbach', NULL, 'Germany');

-- Insert Store Information
INSERT INTO Store (name, brand_name, tax_id, address_id)
VALUES ('Media Markt TV-HiFi-Elektro GmbH', 'Media Markt', 'DE 228434583', 1);

INSERT INTO PaymentMethod (name, abbreviation, description)
VALUES ('SEPA Direct Debit', 'SEPA', 'Contactless SEPA Lastschrift');
...
INSERT INTO Product (
    full_name, short_name, store_description, quantity, q_unit, items_per_package, ipp_unit, 
    line_total_price, unit_price, tax_code, brand, code
)
VALUES 
...
INSERT INTO ReceiptPayment (receipt_id, payment_method_id, amount)
VALUES (1, 1, 10.98);
